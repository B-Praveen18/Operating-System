[24bcs056@mepcolinux e6]$cat ex6.prn
Script started on Monday 07 September 2026 12:03:11 PM IST
[24bcs056@mepcolinux e6]$cat bankers.c
#include <stdio.h>
#include <stdbool.h>
...
[24bcs056@mepcolinux e6]$./bankers
============================================
...
For T1:
Maximum demand of R1: 4
Maximum demand of R2: 5
Maximum demand of R3: 2

For T2:
Maximum demand of R1: 2
Maximum demand of R2: 4
Maximum demand of R3: 5

For T3:
Maximum demand of R1:
3
Maximum demand of R2: 6
Maximum demand of R3: 6

For T4:
Maximum demand of R1: 6
Maximum demand of R2: 8
Maximum demand of R3: 4

For T5:
Maximum demand of R1: 3
Maximum demand of R2: 6
Maximum demand of R3: 3

Is WORK / AVAILABLE vector given? (y/n): n

WORK is not given.
Enter TOTAL resources to calculate WORK.
Total R1: 7
Total R2: 14
Total R3: 12

Calculated WORK / AVAILABLE = ( 1 4 4 )
...
T2 can finish because Need <= Work
Work before T2 finishes: ( 1 4 4 )
T2 releases its Allocation.
New Work: ( 2 6 6 )

T3 can finish because Need <= Work
Work before T3 finishes: ( 2 6 6 )
T3 releases its Allocation.
New Work: ( 4 8 9 )

T5 can finish because Need <= Work
Work before T5 finishes: ( 4 8 9 )
T5 releases its Allocation.
New Work: ( 5 10 10 )

T1 can finish because Need <= Work
Work before T1 finishes: ( 5 10 10 )
T1 releases its Allocation.
New Work: ( 7 13 10 )

T4 can finish because Need <= Work
Work before T4 finishes: ( 7 13 10 )
T4 releases its Allocation.
New Work: ( 7 14 12 )

====================================
SYSTEM IS IN A SAFE STATE
Safe Sequence: T2 -> T3 -> T5 -> T1 -> T4
====================================
...
Which process is requesting resources? (1 to 5): 1

Enter resource request for T1:
Resource R1: 1
Resource R2: 1
Resource R3: 1
...
REQUEST DENIED!
Granting this request would make the system UNSAFE.
...
REQUEST ACCEPTED!
The request was granted and the system remains SAFE.

Initial WORK = ( 0 3 3 )

T2 can finish because Need <= Work
Work before T2 finishes: ( 0 3 3 )
T2 releases its Allocation.
New Work: ( 2 6 6 )
...
Enter your choice: 4
[24bcs056@mepcolinux e6]$exit
exit

Script done on Monday 07 September 2026 12:03:23 PM IST
