[24bcs056@mepcolinux ex4]$cat final.txt
[24bcs056@mepcolinux ex4]$cat q1.c
#include <stdio.h>
#include <limits.h>
struct Process{
    int pid;
...
7. Exit
Enter your choice: 4
Enter Priority of P1 (lower number = higher priority): 3
Enter Priority of P2 (lower number = higher priority): 1
Enter Priority of P3 (lower number = higher priority): 4
Enter Priority of P4 (lower number = higher priority): 2
...
Gantt Chart:
| P1 | P2 | P3 | P1 | P4 | P2 | P3 | P1 | P3 | P1 |
0    2    4    6    8    9    10    12    14    15    16
